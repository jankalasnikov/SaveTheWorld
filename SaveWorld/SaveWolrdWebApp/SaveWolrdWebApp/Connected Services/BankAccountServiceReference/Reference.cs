...
namespace SaveWolrdWebApp.BankAccountServiceReference {
    ...
    public interface IBankAccountService {
        ...
        SaveWolrdWebApp.BankAccountServiceReference.BankAccountB GetBankAccount(int accountNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBankAccountService/GetBankAccount", ReplyAction="http://tempuri.org/IBankAccountService/GetBankAccountResponse")]
        System.Threading.Tasks.Task<SaveWolrdWebApp.BankAccountServiceReference.BankAccountB> GetBankAccountAsync(int accountNumber);
        ...
        SaveWolrdWebApp.BankAccountServiceReference.BankAccountB GetBankAccountById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBankAccountService/GetBankAccountById", ReplyAction="http://tempuri.org/IBankAccountService/GetBankAccountByIdResponse")]
        System.Threading.Tasks.Task<SaveWolrdWebApp.BankAccountServiceReference.BankAccountB> GetBankAccountByIdAsync(int id);
        ...
        void Update(SaveWolrdWebApp.BankAccountServiceReference.BankAccountB bankAccountBefore);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBankAccountService/Update", ReplyAction="http://tempuri.org/IBankAccountService/UpdateResponse")]
        System.Threading.Tasks.Task UpdateAsync(SaveWolrdWebApp.BankAccountServiceReference.BankAccountB bankAccountBefore);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBankAccountServiceChannel : SaveWolrdWebApp.BankAccountServiceReference.IBankAccountService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BankAccountServiceClient : System.ServiceModel.ClientBase<SaveWolrdWebApp.BankAccountServiceReference.IBankAccountService>, SaveWolrdWebApp.BankAccountServiceReference.IBankAccountService {
        ...
        public SaveWolrdWebApp.BankAccountServiceReference.BankAccountB GetBankAccount(int accountNumber) {
            return base.Channel.GetBankAccount(accountNumber);
        }
        
        public System.Threading.Tasks.Task<SaveWolrdWebApp.BankAccountServiceReference.BankAccountB> GetBankAccountAsync(int accountNumber) {
            return base.Channel.GetBankAccountAsync(accountNumber);
        }
        
        public SaveWolrdWebApp.BankAccountServiceReference.BankAccountB GetBankAccountById(int id) {
            return base.Channel.GetBankAccountById(id);
        }
        
        public System.Threading.Tasks.Task<SaveWolrdWebApp.BankAccountServiceReference.BankAccountB> GetBankAccountByIdAsync(int id) {
        ...
        public void Update(SaveWolrdWebApp.BankAccountServiceReference.BankAccountB bankAccountBefore) {
            base.Channel.Update(bankAccountBefore);
        }
        
        public System.Threading.Tasks.Task UpdateAsync(SaveWolrdWebApp.BankAccountServiceReference.BankAccountB bankAccountBefore) {
