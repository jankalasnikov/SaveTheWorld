...
namespace SaveWorldWebsite.DisasterServiceReference {
    ...
    public interface IDisasterService {
        ...
        SaveWorldWebsite.DisasterServiceReference.DisasterB[] GetAllDisasters();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/GetAllDisasters", ReplyAction="http://tempuri.org/IDisasterService/GetAllDisastersResponse")]
        System.Threading.Tasks.Task<SaveWorldWebsite.DisasterServiceReference.DisasterB[]> GetAllDisastersAsync();
        ...
        SaveWorldWebsite.DisasterServiceReference.DisasterB GetDisasterByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/GetDisasterByName", ReplyAction="http://tempuri.org/IDisasterService/GetDisasterByNameResponse")]
        System.Threading.Tasks.Task<SaveWorldWebsite.DisasterServiceReference.DisasterB> GetDisasterByNameAsync(string name);
        ...
        bool UpdateDisaster(SaveWorldWebsite.DisasterServiceReference.DisasterB disaster);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/UpdateDisaster", ReplyAction="http://tempuri.org/IDisasterService/UpdateDisasterResponse")]
        System.Threading.Tasks.Task<bool> UpdateDisasterAsync(SaveWorldWebsite.DisasterServiceReference.DisasterB disaster);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDisasterServiceChannel : SaveWorldWebsite.DisasterServiceReference.IDisasterService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DisasterServiceClient : System.ServiceModel.ClientBase<SaveWorldWebsite.DisasterServiceReference.IDisasterService>, SaveWorldWebsite.DisasterServiceReference.IDisasterService {
        ...
        public SaveWorldWebsite.DisasterServiceReference.DisasterB[] GetAllDisasters() {
            return base.Channel.GetAllDisasters();
        }
        
        public System.Threading.Tasks.Task<SaveWorldWebsite.DisasterServiceReference.DisasterB[]> GetAllDisastersAsync() {
            return base.Channel.GetAllDisastersAsync();
        }
        
        public SaveWorldWebsite.DisasterServiceReference.DisasterB GetDisasterByName(string name) {
            return base.Channel.GetDisasterByName(name);
        }
        
        public System.Threading.Tasks.Task<SaveWorldWebsite.DisasterServiceReference.DisasterB> GetDisasterByNameAsync(string name) {
            return base.Channel.GetDisasterByNameAsync(name);
        }
        
        public bool UpdateDisaster(SaveWorldWebsite.DisasterServiceReference.DisasterB disaster) {
            return base.Channel.UpdateDisaster(disaster);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateDisasterAsync(SaveWorldWebsite.DisasterServiceReference.DisasterB disaster) {
