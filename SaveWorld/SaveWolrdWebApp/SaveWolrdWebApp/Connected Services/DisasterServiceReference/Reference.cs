...
namespace SaveWolrdWebApp.DisasterServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DisasterServiceReference.IDisasterService")]
    public interface IDisasterService {
        ...
        SaveWolrdWebApp.DisasterServiceReference.DisasterB[] GetAllDisasters();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/GetAllDisasters", ReplyAction="http://tempuri.org/IDisasterService/GetAllDisastersResponse")]
        System.Threading.Tasks.Task<SaveWolrdWebApp.DisasterServiceReference.DisasterB[]> GetAllDisastersAsync();
        ...
        SaveWolrdWebApp.DisasterServiceReference.DisasterB GetDisasterByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/GetDisasterByName", ReplyAction="http://tempuri.org/IDisasterService/GetDisasterByNameResponse")]
        System.Threading.Tasks.Task<SaveWolrdWebApp.DisasterServiceReference.DisasterB> GetDisasterByNameAsync(string name);
        ...
        bool UpdateDisaster(SaveWolrdWebApp.DisasterServiceReference.DisasterB disaster);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/UpdateDisaster", ReplyAction="http://tempuri.org/IDisasterService/UpdateDisasterResponse")]
        System.Threading.Tasks.Task<bool> UpdateDisasterAsync(SaveWolrdWebApp.DisasterServiceReference.DisasterB disaster);
        ...
        bool CreateDisaster(SaveWolrdWebApp.DisasterServiceReference.DisasterB newDisaster);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDisasterService/CreateDisaster", ReplyAction="http://tempuri.org/IDisasterService/CreateDisasterResponse")]
        System.Threading.Tasks.Task<bool> CreateDisasterAsync(SaveWolrdWebApp.DisasterServiceReference.DisasterB newDisaster);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDisasterServiceChannel : SaveWolrdWebApp.DisasterServiceReference.IDisasterService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DisasterServiceClient : System.ServiceModel.ClientBase<SaveWolrdWebApp.DisasterServiceReference.IDisasterService>, SaveWolrdWebApp.DisasterServiceReference.IDisasterService {
        ...
        public SaveWolrdWebApp.DisasterServiceReference.DisasterB[] GetAllDisasters() {
            return base.Channel.GetAllDisasters();
        }
        
        public System.Threading.Tasks.Task<SaveWolrdWebApp.DisasterServiceReference.DisasterB[]> GetAllDisastersAsync() {
            return base.Channel.GetAllDisastersAsync();
        }
        
        public SaveWolrdWebApp.DisasterServiceReference.DisasterB GetDisasterByName(string name) {
            return base.Channel.GetDisasterByName(name);
        }
        
        public System.Threading.Tasks.Task<SaveWolrdWebApp.DisasterServiceReference.DisasterB> GetDisasterByNameAsync(string name) {
            return base.Channel.GetDisasterByNameAsync(name);
        }
        
        public bool UpdateDisaster(SaveWolrdWebApp.DisasterServiceReference.DisasterB disaster) {
            return base.Channel.UpdateDisaster(disaster);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateDisasterAsync(SaveWolrdWebApp.DisasterServiceReference.DisasterB disaster) {
        ...
        public bool CreateDisaster(SaveWolrdWebApp.DisasterServiceReference.DisasterB newDisaster) {
            return base.Channel.CreateDisaster(newDisaster);
        }
        
        public System.Threading.Tasks.Task<bool> CreateDisasterAsync(SaveWolrdWebApp.DisasterServiceReference.DisasterB newDisaster) {
